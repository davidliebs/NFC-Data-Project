...
# creating a list from the spark dataframe in the format [(Datetime(2020, 10, 7, 17, 52, 5, 123456), 'Lounge'), (Datetime(2020, 10, 7, 17, 52, 5, 123456), 'Kitchen') ...]
formatted_nfc_list = [tuple(x) for x in tuple(api_nfc_df.collect())]
